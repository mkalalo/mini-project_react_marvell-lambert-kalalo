...
export default function LoadingSvg() {
    return (
        <>
            <div id='loading'>
                {/* <svg xmlns="http://www.w3.org/2000/svg" style={{margin: 'auto', background: 'rgb(241, 242, 243)', display: 'block', shapeRendering: 'auto'}} width="200px" height="200px" viewBox="0 0 100 100">
